...
public:
  ...
  Int operator()(const TensorNode<N> node, const Real coefficient, const Real coeff_map) const;
  ...
  RangeSlice<iterator> operator()(Real const *const u, Real const *const u_map) const;
